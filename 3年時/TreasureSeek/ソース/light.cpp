...
HRESULT CLight::Init(void)
{
	...
	m_aLight[FIRST_LIGHT].Diffuse = D3DXCOLOR(0.37f, 0.37f, 0.37f, 1.0f);				// 拡散色設定
	...
	//m_aLight[SECOND_LIGHT].Diffuse = D3DXCOLOR(0.5f, 0.5f, 0.5f, 0.5f);				// 拡散色設定

	/////// ライトの向き初期化 /////
	//vecDir = D3DXVECTOR3(0.0f, -0.5f, -10.0f);										// ライトの方向 ※重要※
	//D3DXVec3Normalize( (D3DXVECTOR3 *)&m_aLight[SECOND_LIGHT].Direction, &vecDir);	// ライトの方向修正
	...
	/////// ライトの向き初期化 /////
	//vecDir = D3DXVECTOR3(-4.0f, 0.3f, 0.5f);
	//vecDir = D3DXVECTOR3(-4.0f, 0.3f, 1.0f);// ライトの方向 ※重要※
	//D3DXVec3Normalize( (D3DXVECTOR3 *)&m_aLight[THIRD_LIGHT].Direction, &vecDir);	// ライトの方向修正
